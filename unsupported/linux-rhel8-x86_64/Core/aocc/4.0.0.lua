-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-05-23 13:25:50.817381
--
...
prepend_path("MODULEPATH", "/appl/spack/v020/unsupported/linux-rhel8-x86_64/aocc/4.0.0")
