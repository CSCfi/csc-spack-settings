...
class Grads(AutotoolsPackage):
    ...
    variant('udunits' , default=False, description='Enable udunits2 unit conversion support')
    ...
    depends_on('netcdf-c~mpi+hdf4',        when='+netcdf+hdf4')
    ...
    def configure_args(self):
        ...
        if '+udunits' in self.spec:
            config_args.append('--with-udunits=' + self.spec['udunits'].prefix)
