...
class Tester(CMakePackage, CudaPackage):
    ...
    # Fake package for source setup testing
    # version(
    #    '22', sha256='7ac7138e6716f08e4003f209613928819602607bc65474f37786c446cd2afd46')
    version(
    ...
    resources = {
        ...
        # Fake package version '22': ('22', '5acf84f2e9dd299e78328dd939883b36d7d54876d62d7e9c9dc83e013dcce268'),
    ...
    def cmake_args(self):
        ...
        options = ["-DBUILD_PYTHON:BOOLEAN=FALSE", "-DDOWNLOAD_MINICONDA:BOOLEAN=FALSE"]
    ...
    def cmake(self, spec, prefix):
        ...
        super(Tester, self).cmake(spec, prefix)
