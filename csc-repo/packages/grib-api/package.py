...
class GribApi(CMakePackage):
    ...
    url = 'https://github.com/weathersource/grib_api/archive/v1.21.0.tar.gz'
    list_url = 'https://github.com/weathersource/grib_api/releases'

    maintainers = ['skosukhin']
    version('1.21.0', sha256='17072f60ac6db4d717f3b174ace1d86780d41d46940fa7a438c93cb973001b7f')
