...
class Zoltan(AutotoolsPackage):
    ...
    variant('id_type',
            default='uint',
            values=('uint','ulong','ullong'),
            multi=False,
            description='Zoltan global ID type')
    ...
    def configure_args(self):
        ...
        if spec.variants['id_type'].value == 'uint':
            config_args.append('--with-id-type=uint')
        if spec.variants['id_type'].value == 'ulong':
            config_args.append('--with-id-type=ulong')
        if spec.variants['id_type'].value == 'ullong':
            config_args.append('--with-id-type=ullong')
