-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-06-13 13:25:43.663882
--
...
prepend_path("MODULEPATH", "/appl/spack/v018/modulefiles/linux-rhel8-x86_64/gcc/11.3.0")
...
setenv("GCC_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-8.5.0/gcc-11.3.0-i44hho")
setenv("CC", "gcc")
setenv("CXX", "g++")
setenv("FC", "gfortran")
setenv("F90", "gfortran")
