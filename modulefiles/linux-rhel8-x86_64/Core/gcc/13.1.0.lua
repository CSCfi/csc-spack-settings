-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-05-24 15:40:35.267560
--
...
prepend_path("MODULEPATH", "/appl/spack/v020/modulefiles/linux-rhel8-x86_64/gcc/13.1.0")
...
setenv("GCC_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-8.5.0/gcc-13.1.0-how4ki")
setenv("CC", "gcc")
setenv("CXX", "g++")
setenv("FC", "gfortran")
setenv("F90", "gfortran")
