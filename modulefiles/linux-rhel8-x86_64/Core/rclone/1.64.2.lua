-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-01-03 17:24:26.469771
--
...
setenv("RCLONE_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-8.5.0/rclone-1.64.2-bse6zc")
setenv("GOMAXPROCS", "4")
