-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-05-24 15:40:34.833173
--
...
prepend_path("MODULEPATH", "/appl/spack/v020/modulefiles/linux-rhel8-x86_64/aocc/4.0.0")
...
setenv("AOCC_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-8.5.0/aocc-4.0.0-kfimbs")
