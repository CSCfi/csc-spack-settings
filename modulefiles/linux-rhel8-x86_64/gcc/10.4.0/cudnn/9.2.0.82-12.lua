-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2025-02-19 16:10:43.086085
--
...
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v020/install-tree/gcc-10.4.0/cudnn-9.2.0.82-12-cbe6h5/lib", ":")
setenv("CUDNN_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-10.4.0/cudnn-9.2.0.82-12-cbe6h5")
