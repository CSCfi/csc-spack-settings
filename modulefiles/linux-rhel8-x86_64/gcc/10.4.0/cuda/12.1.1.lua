-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-06-19 10:53:49.769562
--
...
setenv("CUDA_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-10.4.0/cuda-12.1.1-2ppwzf")
append_path("LIBRARY_PATH", "/appl/spack/v020/install-tree/gcc-10.4.0/cuda-12.1.1-2ppwzf/lib64/stubs", ":")
