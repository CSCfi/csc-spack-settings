-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-09-14 12:52:42.466529
--
...
setenv("CUDA_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-11.3.0/cuda-11.7.0-zucvj4")
append_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/cuda-11.7.0-zucvj4/lib64/stubs", ":")
