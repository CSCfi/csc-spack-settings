-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-11-04 12:02:59.919370
--
...
prepend_path("MODULEPATH", "/appl/spack/v018/modulefiles/linux-rhel8-x86_64/openmpi/4.1.4-w2aekqa/gcc/11.3.0")
...
setenv("OPENMPI_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-11.3.0/openmpi-4.1.4-w2aekq")
