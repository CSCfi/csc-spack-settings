-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-05-24 15:40:35.375999
--
...
setenv("GSL_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-13.1.0/gsl-2.7.1-2azbnd")
