-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-09-12 15:26:14.203980
--
...
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v020/install-tree/gcc-13.1.0/jemalloc-5.3.0-ka2qsx/lib", ":")
...
setenv("JEMALLOC_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-13.1.0/jemalloc-5.3.0-ka2qsx")
