-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-05-24 15:40:35.876531
--
...
prepend_path("MODULEPATH", "/appl/spack/v020/modulefiles/linux-rhel8-x86_64/openmpi/4.1.5-3hdwocc/gcc/13.1.0")
...
setenv("OPENMPI_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-13.1.0/openmpi-4.1.5-3hdwoc")
