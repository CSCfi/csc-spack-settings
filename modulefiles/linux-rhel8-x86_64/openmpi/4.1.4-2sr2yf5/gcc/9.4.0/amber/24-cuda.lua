-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-10-07 16:25:21.267355
--
-- amber@24%gcc@9.4.0+cuda~ipo+mkl+mpi~openmp+python~update~x11 build_type=RelWithDebInfo cuda_arch=none arch=linux-rhel8-cascadelake/4o4i6ne
--
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/share/man", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/", ":")
...
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib", ":")
setenv("PERL5LIB", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib/perl")
setenv("QUICK_BASIS", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/AmberTools/src/quick/basis")
setenv("AMBERHOME", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/bin", ":")
prepend_path("PYTHONPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n/lib/python3.9/site-packages", ":")
setenv("AMBER_PREFIX", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/cuda-11.1.1-lfaa3j/lib", ":")
setenv("AMBER_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-24-4o4i6n")
