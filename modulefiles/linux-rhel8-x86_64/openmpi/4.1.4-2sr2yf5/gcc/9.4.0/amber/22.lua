-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-11-16 14:58:48.503812
--
-- amber@22%gcc@9.4.0~cuda~ipo+mkl+mpi~openmp+python~update~x11 build_type=Release arch=linux-rhel8-cascadelake/7bl3xbv
--
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/lib", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/", ":")
...
setenv("AMBERHOME", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/lib", ":")
setenv("PERL5LIB", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/lib/perl")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/bin", ":")
prepend_path("PYTHONPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb/lib/python3.9/site-packages", ":")
setenv("AMBER_PREFIX", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb")
setenv("AMBER_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-9.4.0/amber-22-7bl3xb")
