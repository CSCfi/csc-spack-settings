-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-01-16 12:53:09.308310
--
-- gromacs@2022.4%gcc@9.4.0~blas~cp2k+cuda~cycle_subcounters~double+hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-cascadelake/wzs4myp
--
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my/share/man", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.4-wzs4my")
