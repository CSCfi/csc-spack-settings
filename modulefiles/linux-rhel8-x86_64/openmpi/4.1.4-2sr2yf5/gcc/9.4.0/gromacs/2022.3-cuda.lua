-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-11-04 12:23:52.707493
--
-- gromacs@2022.3%gcc@9.4.0~blas~cp2k+cuda~cycle_subcounters~double+hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-cascadelake/ylthcks
--
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck/share/man", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-9.4.0/gromacs-2022.3-ylthck")
