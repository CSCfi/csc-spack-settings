-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-09-02 13:34:31.245550
--
-- scorep@7.0%gcc@11.2.0+mpi+papi~pdt~shmem~unwind arch=linux-rhel8-zen2/b7qajkn
--
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-11.2.0/scorep-7.0-b7qajk/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/scorep-7.0-b7qajk/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/scorep-7.0-b7qajk/lib", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/scorep-7.0-b7qajk/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/scorep-7.0-b7qajk/", ":")
...
setenv("SCOREP_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-11.2.0/scorep-7.0-b7qajk")
