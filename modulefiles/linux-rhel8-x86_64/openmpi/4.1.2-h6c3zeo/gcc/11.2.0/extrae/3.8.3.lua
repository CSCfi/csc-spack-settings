-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-05-11 12:39:51.522076
--
-- extrae@3.8.3%gcc@11.2.0~cuda~cupti~dyninst+papi arch=linux-rhel8-zen2/ovmxmsk
--
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-11.2.0/extrae-3.8.3-ovmxms/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/extrae-3.8.3-ovmxms/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/extrae-3.8.3-ovmxms/lib", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/extrae-3.8.3-ovmxms/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/extrae-3.8.3-ovmxms/", ":")
setenv("EXTRAE_HOME", "/appl/spack/v017/install-tree/gcc-11.2.0/extrae-3.8.3-ovmxms")
setenv("EXTRAE_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-11.2.0/extrae-3.8.3-ovmxms")
