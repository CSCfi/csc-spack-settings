-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-11-04 12:29:37.334089
--
-- gromacs@2022.3%gcc@11.2.0~blas~cuda~cycle_subcounters~double~hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-zen2/wxfhwo2
--
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo/share/man", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-11.2.0/gromacs-2022.3-wxfhwo")
