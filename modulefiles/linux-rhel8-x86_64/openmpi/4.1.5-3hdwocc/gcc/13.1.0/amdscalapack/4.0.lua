-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-08-28 10:20:05.197719
--
...
setenv("AMDSCALAPACK_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-13.1.0/amdscalapack-4.0-t6hkc4")
