-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-03-21 12:20:52.244956
--
...
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-13.1.0/gromacs-2024.1-nknsis")
