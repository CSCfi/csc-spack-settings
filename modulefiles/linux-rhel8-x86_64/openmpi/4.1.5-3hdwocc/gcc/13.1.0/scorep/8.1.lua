-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-04-29 16:59:34.085562
--
...
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v020/install-tree/gcc-13.1.0/cubew-4.8-4pfbby/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v020/install-tree/gcc-13.1.0/otf2-3.0-j3ca6b/lib", ":")
setenv("SCOREP_INSTALL_ROOT", "/appl/spack/v020/install-tree/gcc-13.1.0/scorep-8.1-duf4kx")
