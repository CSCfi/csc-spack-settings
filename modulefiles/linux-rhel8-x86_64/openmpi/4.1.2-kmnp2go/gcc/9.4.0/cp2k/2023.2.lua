-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-09-01 12:44:16.784692
--
...
setenv("CP2K_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-9.4.0/cp2k-2023.2-u64wvn")
