-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-11-10 13:24:06.007083
--
...
setenv("CP2K_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-9.4.0/cp2k-2022.2-6hf4r2")
