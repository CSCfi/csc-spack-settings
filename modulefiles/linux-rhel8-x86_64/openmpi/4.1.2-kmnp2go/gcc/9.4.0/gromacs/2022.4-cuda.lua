-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-01-16 14:29:55.579820
--
-- gromacs@2022.4%gcc@9.4.0~blas+cuda~cycle_subcounters~double~hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-zen2/z35hyqw
--
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq/share/man", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.4-z35hyq")
