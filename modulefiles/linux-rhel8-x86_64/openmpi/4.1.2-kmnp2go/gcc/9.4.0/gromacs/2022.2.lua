-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-09-02 12:39:54.268483
--
-- gromacs@2022.2%gcc@9.4.0~blas~cuda~cycle_subcounters~double~hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-zen2/5rocxjh
--
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj/share/man", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-9.4.0/gromacs-2022.2-5rocxj")
