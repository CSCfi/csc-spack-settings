-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-11-16 16:50:37.574887
--
-- amber@22%gcc@9.4.0~cuda~ipo~mkl+mpi~openmp+python~update~x11 build_type=RelWithDebInfo cuda_arch=none arch=linux-rhel8-zen2/zdcyh4m
--
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/lib", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/", ":")
...
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/lib", ":")
setenv("PERL5LIB", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/lib/perl")
setenv("AMBERHOME", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4")
append_path("PATH", "/users/ilvonens/.local/bin", ":")
append_path("PATH", "/users/ilvonens/bin", ":")
append_path("PATH", "/appl/bin", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/bin", ":")
prepend_path("PYTHONPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4/lib/python3.8/site-packages", ":")
setenv("AMBER_PREFIX", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4")
setenv("AMBER_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-22-zdcyh4")
