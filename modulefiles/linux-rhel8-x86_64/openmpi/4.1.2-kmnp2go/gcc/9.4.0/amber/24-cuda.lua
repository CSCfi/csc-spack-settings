-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-10-07 17:27:42.862220
--
-- amber@24%gcc@9.4.0+cuda~ipo~mkl+mpi~openmp+python~update~x11 build_type=RelWithDebInfo cuda_arch=none arch=linux-rhel8-zen2/ho5lb64
--
...
whatis([[Configure options : -DDOWNLOAD_MINICONDA:BOOLEAN=FALSE -DBLA_VENDOR=OpenBLAS -DBUILD_PYTHON:BOOLEAN=TRUE -DFORCE_EXTERNAL_LIBS=mpi4py -DCHECK_UPDATES:BOOLEAN=FALSE -DAPPLY_UPDATES:BOOLEAN=FALSE -DCOMPILER=GNU -DNetCDF_INCLUDES_F77:PATH=/appl/spack/v017/install-tree/gcc-9.4.0/netcdf-fortran-4.5.3-yxu75d/include -DNetCDF_INCLUDES_F90:PATH=/appl/spack/v017/install-tree/gcc-9.4.0/netcdf-fortran-4.5.3-yxu75d/include -DCUDA:BOOLEAN=TRUE -DMPI:BOOLEAN=TRUE]])
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/share/man", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/", ":")
...
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib", ":")
setenv("PERL5LIB", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib/perl")
setenv("QUICK_BASIS", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/AmberTools/src/quick/basis")
setenv("AMBERHOME", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6")
append_path("PATH", "/users/ilvonens/.local/bin", ":")
append_path("PATH", "/users/ilvonens/bin", ":")
append_path("PATH", "/appl/bin", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/bin", ":")
prepend_path("PYTHONPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6/lib/python3.8/site-packages", ":")
setenv("AMBER_PREFIX", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/cuda-11.1.1-3osohj/lib", ":")
setenv("AMBER_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-9.4.0/amber-24-ho5lb6")
