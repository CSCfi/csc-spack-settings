-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-05-11 12:48:12.615245
--
-- extrae@3.8.3%gcc@9.4.0~cuda~cupti~dyninst+papi arch=linux-rhel8-zen2/gsmir3m
--
...
prepend_path("CPATH", "/appl/spack/v017/install-tree/gcc-9.4.0/extrae-3.8.3-gsmir3/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/extrae-3.8.3-gsmir3/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/extrae-3.8.3-gsmir3/lib", ":")
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/extrae-3.8.3-gsmir3/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-9.4.0/extrae-3.8.3-gsmir3/", ":")
setenv("EXTRAE_HOME", "/appl/spack/v017/install-tree/gcc-9.4.0/extrae-3.8.3-gsmir3")
setenv("EXTRAE_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-9.4.0/extrae-3.8.3-gsmir3")
