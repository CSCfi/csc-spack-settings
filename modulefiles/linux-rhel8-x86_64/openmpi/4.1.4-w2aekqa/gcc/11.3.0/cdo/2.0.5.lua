-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-10-07 15:21:48.788689
--
-- cdo@2.0.5%gcc@11.3.0+curl~external-grib1~fftw3+hdf5+libxml2~magics+netcdf+openmp+proj+szip+udunits2 grib2=eccodes arch=linux-rhel8-cascadelake/vk3w3gh
--
...
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/cdo-2.0.5-vk3w3g/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/cdo-2.0.5-vk3w3g/", ":")
setenv("PROJ_LIB", "/appl/spack/v018/install-tree/gcc-11.3.0/proj-8.2.1-zj2pln/share/proj")
setenv("CDO_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-11.3.0/cdo-2.0.5-vk3w3g")
