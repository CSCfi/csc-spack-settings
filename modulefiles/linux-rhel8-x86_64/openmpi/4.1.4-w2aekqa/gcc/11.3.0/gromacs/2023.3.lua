-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-11-16 10:14:03.287847
--
-- gromacs@2023.3%gcc@11.3.0~blas~cp2k~cuda~cycle_subcounters~double+hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-cascadelake/azbu7pb
--

whatis([[Name : gromacs]])
whatis([[Version : 2023.3]])
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p/share/man", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2023.3-azbu7p")
