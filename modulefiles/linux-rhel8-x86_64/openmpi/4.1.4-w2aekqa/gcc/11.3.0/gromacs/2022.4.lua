-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-01-16 12:46:39.012705
--
-- gromacs@2022.4%gcc@11.3.0~blas~cp2k~cuda~cycle_subcounters~double+hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-cascadelake/gkywggu
--
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg/share/man", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2022.4-gkywgg")
