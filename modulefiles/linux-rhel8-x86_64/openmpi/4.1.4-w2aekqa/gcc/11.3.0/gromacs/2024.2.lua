-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-05-22 12:32:13.522360
--
-- gromacs@2024.2%gcc@11.3.0~blas~cp2k~cuda~cycle_subcounters~double+hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=Release arch=linux-rhel8-cascadelake/deyjnno
--
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn/lib64", ":")
prepend_path("MANPATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn/share/man", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn/", ":")
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-11.3.0/gromacs-2024.2-deyjnn")
