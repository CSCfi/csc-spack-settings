-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-08-26 11:14:14.438902
--
-- plumed@2.8.0%gcc@11.3.0+gsl+mpi+shared arrayfire=none optional_modules=all arch=linux-rhel8-cascadelake/pc6pekf
--
...
prepend_path("CPATH", "/appl/spack/v018/install-tree/gcc-11.3.0/plumed-2.8.0-pc6pek/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/plumed-2.8.0-pc6pek/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/plumed-2.8.0-pc6pek/lib", ":")
prepend_path("PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/plumed-2.8.0-pc6pek/bin", ":")
prepend_path("PKG_CONFIG_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/plumed-2.8.0-pc6pek/lib/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v018/install-tree/gcc-11.3.0/plumed-2.8.0-pc6pek/", ":")
setenv("PLUMED_INSTALL_ROOT", "/appl/spack/v018/install-tree/gcc-11.3.0/plumed-2.8.0-pc6pek")
