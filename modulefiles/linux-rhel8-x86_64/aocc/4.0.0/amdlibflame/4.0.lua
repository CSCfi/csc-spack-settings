-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-04-24 14:32:32.991675
--
-- amdlibflame@4.0%aocc@4.0.0~debug~ilp64+lapack2flame+shared+static build_system=autotools threads=none arch=linux-rhel8-x86_64/3pswpsu
--
...
whatis([[Configure options : LIBS=-L/appl/spack/v019/install-tree/aocc-4.0.0/amdblis-4.0-4jodzr/lib -lblis -lblis-mt --enable-lapack2flame --enable-static-build --enable-dynamic-build --disable-debug --enable-multithreading=no --disable-supermatrix --enable-max-arg-list-hack --enable-amd-aocc-flags]])
...
prepend_path("CPATH", "/appl/spack/v019/install-tree/aocc-4.0.0/amdlibflame-4.0-3pswps/include", ":")
prepend_path("LIBRARY_PATH", "/appl/spack/v019/install-tree/aocc-4.0.0/amdlibflame-4.0-3pswps/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v019/install-tree/aocc-4.0.0/amdlibflame-4.0-3pswps/lib", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v019/install-tree/aocc-4.0.0/amdlibflame-4.0-3pswps/.", ":")
setenv("AMDLIBFLAME_INSTALL_ROOT", "/appl/spack/v019/install-tree/aocc-4.0.0/amdlibflame-4.0-3pswps")
