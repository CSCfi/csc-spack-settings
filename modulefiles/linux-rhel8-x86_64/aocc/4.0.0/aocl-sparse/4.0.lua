-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-05-24 15:40:34.933406
--
...
setenv("AOCL_SPARSE_INSTALL_ROOT", "/appl/spack/v020/install-tree/aocc-4.0.0/aocl-sparse-4.0-cy2hdh")
