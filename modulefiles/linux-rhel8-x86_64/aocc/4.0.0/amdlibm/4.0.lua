-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2023-05-24 15:40:34.568537
--
...
setenv("AMDLIBM_INSTALL_ROOT", "/appl/spack/v020/install-tree/aocc-4.0.0/amdlibm-4.0-2dyyfk")
