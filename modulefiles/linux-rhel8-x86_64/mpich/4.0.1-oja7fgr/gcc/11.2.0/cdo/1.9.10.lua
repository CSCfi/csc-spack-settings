-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-03-24 12:41:27.324529
--
-- cdo@1.9.10%gcc@11.2.0+curl~external-grib1+fftw3+hdf5+libxml2~magics+netcdf+openmp+proj+szip+udunits2 grib2=eccodes arch=linux-rhel8-zen2/dmfzvrr
--
...
prepend_path("PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/cdo-1.9.10-dmfzvr/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/appl/spack/v017/install-tree/gcc-11.2.0/cdo-1.9.10-dmfzvr/", ":")
setenv("PROJ_LIB", "/appl/spack/v017/install-tree/gcc-11.2.0/proj-8.1.0-72rqsv/share/proj")
setenv("CDO_INSTALL_ROOT", "/appl/spack/v017/install-tree/gcc-11.2.0/cdo-1.9.10-dmfzvr")
